...
var _datepickerKeymapService = require('./datepicker-keymap-service');
...
var NgbDatepicker = function () {
    ...
    NgbDatepicker.prototype.navigateTo = /**
                                         ...
                                         */
    function (date) {
        this._service.open(date ? new _ngbDate.NgbDate(date.year, date.month, 1) : this._calendar.getToday());
    };
    ...
    NgbDatepicker.prototype.ngOnInit = function () {
        if (this.model === undefined) {
            this._service.displayMonths = (0, _util.toInteger)(this.displayMonths);
    ...
    NgbDatepicker.decorators = [{ type: _core.Component, args: [{
    ...
    NgbDatepicker.ctorParameters = function () {
        return [{ type: _datepickerKeymapService.NgbDatepickerKeyMapService }, { type: _datepickerService.NgbDatepickerService }, { type: _ngbCalendar.NgbCalendar }, { type: _datepickerI18n.NgbDatepickerI18n }, { type: _datepickerConfig.NgbDatepickerConfig }, { type: _core.ChangeDetectorRef }, { type: _core.ElementRef }, { type: _ngbDateAdapter2.NgbDateAdapter }];
    };
