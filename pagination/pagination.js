...
exports.NgbPagination = undefined;
...
var NgbPagination = function () {
    ...
    NgbPagination.decorators = [{ type: _core.Component, args: [{
    ...
    NgbPagination.ctorParameters = function () {
        return [{ type: _paginationConfig.NgbPaginationConfig }];
    };
    NgbPagination.propDecorators = {
        "disabled": [{ type: _core.Input }],
        "boundaryLinks": [{ type: _core.Input }],
        "directionLinks": [{ type: _core.Input }],
        "ellipses": [{ type: _core.Input }],
        "rotate": [{ type: _core.Input }],
        "collectionSize": [{ type: _core.Input }],
        "maxSize": [{ type: _core.Input }],
        "page": [{ type: _core.Input }],
        "pageSize": [{ type: _core.Input }],
        "pageChange": [{ type: _core.Output }],
