...
exports.NgbTypeahead = undefined;
...
var _let = require('rxjs/operator/let');
...
var NgbTypeahead = function () {
    function NgbTypeahead(_elementRef, _viewContainerRef, _renderer, _injector, componentFactoryResolver, config, ngZone) {
        ...
        this._valueChanges = (0, _fromEvent.fromEvent)(_elementRef.nativeElement, 'input', function ($event) {
            return $event.target.value;
        });
        this._resubscribeTypeahead = new _BehaviorSubject.BehaviorSubject(null);
    ...
    NgbTypeahead.prototype.ngOnInit = function () {
        var _this = this;
        var inputValues$ = _do2._do.call(this._valueChanges, function (value) {
            _this._inputValueBackup = value;
            if (_this.editable) {
                _this._onChange(value);
            }
        });
        var results$ = _let.letProto.call(inputValues$, this.ngbTypeahead);
        var processedResults$ = _do2._do.call(results$, function () {
            if (!_this.editable) {
                _this._onChange(undefined);
            }
        });
        var userInput$ = _switchMap.switchMap.call(this._resubscribeTypeahead, function () {
    ...
    NgbTypeahead.prototype._formatItemForInput = function (item) {
        return item && this.inputFormatter ? this.inputFormatter(item) : (0, _util.toString)(item);
    };
    ...
    NgbTypeahead.decorators = [{ type: _core.Directive, args: [{
    ...
    NgbTypeahead.ctorParameters = function () {
        return [{ type: _core.ElementRef }, { type: _core.ViewContainerRef }, { type: _core.Renderer2 }, { type: _core.Injector }, { type: _core.ComponentFactoryResolver }, { type: _typeaheadConfig.NgbTypeaheadConfig }, { type: _core.NgZone }];
    };
    NgbTypeahead.propDecorators = {
        "container": [{ type: _core.Input }],
        "editable": [{ type: _core.Input }],
        "focusFirst": [{ type: _core.Input }],
        "inputFormatter": [{ type: _core.Input }],
        "ngbTypeahead": [{ type: _core.Input }],
        "resultFormatter": [{ type: _core.Input }],
        "resultTemplate": [{ type: _core.Input }],
        "showHint": [{ type: _core.Input }],
        "placement": [{ type: _core.Input }],
        "selectItem": [{ type: _core.Output }]
    };
    return NgbTypeahead;
}();
