...
exports.NgbDropdown = exports.NgbDropdownToggle = exports.NgbDropdownMenu = undefined;
...
var NgbDropdownMenu = function () {
    ...
    NgbDropdownMenu.decorators = [{ type: _core.Directive, args: [{ selector: '[ngbDropdownMenu]', host: { '[class.dropdown-menu]': 'true', '[class.show]': 'dropdown.isOpen()' } }] }];
    /** @nocollapse */
    NgbDropdownMenu.ctorParameters = function () {
        return [{ type: undefined, decorators: [{ type: _core.Inject, args: [(0, _core.forwardRef)(function () {
                    return NgbDropdown;
                })] }] }, { type: _core.ElementRef }, { type: _core.Renderer2 }];
    };
...
var NgbDropdownToggle = function () {
    ...
    NgbDropdownToggle.decorators = [{ type: _core.Directive, args: [{
...
var NgbDropdown = function () {
    ...
    NgbDropdown.decorators = [{ type: _core.Directive, args: [{
    ...
    NgbDropdown.ctorParameters = function () {
        return [{ type: _dropdownConfig.NgbDropdownConfig }, { type: _core.NgZone }];
    };
    NgbDropdown.propDecorators = {
        "_menu": [{ type: _core.ContentChild, args: [NgbDropdownMenu] }],
        "_toggle": [{ type: _core.ContentChild, args: [NgbDropdownToggle] }],
        "autoClose": [{ type: _core.Input }],
        "_open": [{ type: _core.Input, args: ['open'] }],
        "placement": [{ type: _core.Input }],
        "openChange": [{ type: _core.Output }]
    };
    return NgbDropdown;
}();
