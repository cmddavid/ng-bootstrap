...
exports.NGB_CAROUSEL_DIRECTIVES = exports.NgbSlideEventDirection = exports.NgbCarousel = exports.NgbSlide = undefined;
...
var NgbSlide = function () {
    ...
    NgbSlide.decorators = [{ type: _core.Directive, args: [{ selector: 'ng-template[ngbSlide]' }] }];
    /** @nocollapse */
...
var NgbCarousel = function () {
    ...
    NgbCarousel.decorators = [{ type: _core.Component, args: [{
    ...
    NgbCarousel.ctorParameters = function () {
        return [{ type: _carouselConfig.NgbCarouselConfig }];
    };
    NgbCarousel.propDecorators = {
        "slides": [{ type: _core.ContentChildren, args: [NgbSlide] }],
        "interval": [{ type: _core.Input }],
        "wrap": [{ type: _core.Input }],
        "keyboard": [{ type: _core.Input }],
        "activeId": [{ type: _core.Input }],
        "slide": [{ type: _core.Output }]
    };
    return NgbCarousel;
}();
...
var NgbSlideEventDirection = exports.NgbSlideEventDirection = undefined;
/**
 * Enum to define the carousel slide event direction
 */
...
var NGB_CAROUSEL_DIRECTIVES = exports.NGB_CAROUSEL_DIRECTIVES = [NgbCarousel, NgbSlide];
