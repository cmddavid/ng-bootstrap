...
exports.NgbModalWindow = undefined;
...
var NgbModalWindow = function () {
    ...
    NgbModalWindow.decorators = [{ type: _core.Component, args: [{
    ...
    NgbModalWindow.propDecorators = {
        "backdrop": [{ type: _core.Input }],
        "keyboard": [{ type: _core.Input }],
        "size": [{ type: _core.Input }],
        "windowClass": [{ type: _core.Input }],
        "dismissEvent": [{ type: _core.Output, args: ['dismiss'] }]
    };
