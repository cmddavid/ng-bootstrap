...
exports.NgbAccordion = exports.NgbPanel = exports.NgbPanelContent = exports.NgbPanelTitle = undefined;
...
var NgbPanelTitle = function () {
    ...
    NgbPanelTitle.decorators = [{ type: _core.Directive, args: [{ selector: 'ng-template[ngbPanelTitle]' }] }];
    /** @nocollapse */
...
var NgbPanelContent = function () {
    ...
    NgbPanelContent.decorators = [{ type: _core.Directive, args: [{ selector: 'ng-template[ngbPanelContent]' }] }];
    /** @nocollapse */
...
var NgbPanel = function () {
    ...
    NgbPanel.decorators = [{ type: _core.Directive, args: [{ selector: 'ngb-panel' }] }];
    /** @nocollapse */
    NgbPanel.ctorParameters = function () {
        return [];
    };
    NgbPanel.propDecorators = {
        ...
        "contentTpl": [{ type: _core.ContentChild, args: [NgbPanelContent] }],
        "titleTpl": [{ type: _core.ContentChild, args: [NgbPanelTitle] }]
    };
    return NgbPanel;
}();
...
var NgbAccordion = function () {
    ...
    NgbAccordion.decorators = [{ type: _core.Component, args: [{
    ...
    NgbAccordion.ctorParameters = function () {
        return [{ type: _accordionConfig.NgbAccordionConfig }];
    };
    NgbAccordion.propDecorators = {
        "panels": [{ type: _core.ContentChildren, args: [NgbPanel] }],
        "activeIds": [{ type: _core.Input }],
        "closeOtherPanels": [{ type: _core.Input, args: ['closeOthers'] }],
        "destroyOnHide": [{ type: _core.Input }],
        "type": [{ type: _core.Input }],
        "panelChange": [{ type: _core.Output }]
    };
    return NgbAccordion;
}();
